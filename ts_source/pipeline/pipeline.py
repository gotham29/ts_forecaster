...
from ts_source.preprocess.preprocess import split_data, check_stationarity
from ts_source.utils.utils import get_args, load_config, validate_config, validate_args, save_data, load_models, make_dir


def run_pipeline(config: dict, data_path=False, output_dir=False, data=False, output_dirs=False):
    """
    Purpose:
